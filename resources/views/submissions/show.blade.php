...
@section('content')
    ...
    @if(!(isset($noFeedback) && $noFeedback))
        ...
        @endif
        @if($submission->participation != null && ($submission->participation->user_id == auth()->user()->id || ($level >= $submission->participation->contest->edit_level && $level >= 7)) && $submission->getAttributes()['result'] >= 0)
        ...
        @endif
        @if($submission->participation == null || ($level >= $submission->participation->contest->edit_level && $level >= 7 && auth()->user()->contestNow() == null))
